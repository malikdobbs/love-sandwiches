...
def get_sales_data():
    """
    Get Sales figure from the user input.
    Run a while loop to collect a valid string of data from the user
    via the terminal, which must be a string of exactly 6 numbers
    seperated by commas. The loop will repeatedly request data from the
    user until they enter valid data requirements.
    """
    while True:
...
def validate_data(values):
    ...
    Raises the ValueError if strings can't be converted into integers,
...
#created new function below using refactoring to simplify 2 functions above
